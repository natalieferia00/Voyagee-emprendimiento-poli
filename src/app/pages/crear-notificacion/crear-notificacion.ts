    ...
    template: `
        ...
        >
            ...
            <tr>
                ...
                <div class="empty-state">
                    ...
                    Haz clic en <strong>“Nueva Notificación”</strong> para crear la primera.
                    </p>
                </div>
                </td>
            </tr>
        ...
        >
            ...
            <div class="col">
                ...
                ></p-datepicker>
                <p-message
                *ngIf="submitted && !nuevaNotificacion.fecha"
                severity="error"
            ...
            <div class="col">
                ...
                />
                <p-message
                *ngIf="submitted && !nuevaNotificacion.hora"
                severity="error"
            ...
            <div class="col">
                ...
                />
                <p-message
                *ngIf="submitted && !nuevaNotificacion.descripcion.trim()"
                severity="error"
    ...
    guardarNotificacion(): void {
        ...
        const esValido = fecha && hora && descripcion.trim();
        ...
        this.messageService.add({
            severity: 'success',
            summary: 'Actualizada',
            detail: 'La notificación fue actualizada correctamente.'
        });
        } else {
        ...
        this.messageService.add({
            severity: 'success',
            summary: 'Creada',
            detail: 'La notificación fue registrada correctamente.'
        });
        }
    ...
    eliminarNotificacion(id: number): void {
        ...
        severity: 'info',
        summary: 'Eliminada',
        detail: 'La notificación fue eliminada correctamente.'
        });
    }
